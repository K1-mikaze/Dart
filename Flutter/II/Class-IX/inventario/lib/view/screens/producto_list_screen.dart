                    ...
                    child: ListTile(
                      ...
                      trailing: Row(
                        ...
                        children: [
                          IconButton(
                            onPressed: () {
                              Navigator.pushNamed(context, AppRoute.productoViewScreen,arguments: producto).then((value) => setState(() {
                              }));
                            },
                          ...
                          IconButton(
                            onPressed: () {
                              Navigator.pushNamed(context, AppRoute.productoFormScreen, arguments: producto)
                                .then((value) => setState(() {}),);                              
                            },
